      ...
      {!isLoggedIn && (
        <>
          <p className="text-gray-700 leading-relaxed">
            ...
            e-DiVA is here to support you with a smart, easy-to-use Virtual
            Assistant designed to help you manage the responsibilities of
            caregiving.
          </p>
          <p className="text-gray-700 leading-relaxed">
          ...
          <ul className="list-disc pl-5 space-y-2 text-gray-700">
            ...
            <li>
              <span className="font-semibold">Video tutorials</span> to help
              with everyday caregiving tasks
            </li>
            <li>
              <span className="font-semibold">Tips and strategies</span> to
      ...
      {isLoggedIn && (
        <div className="space-y-6">
          ...
          <div className="space-y-3">
            <p className="text-gray-700 leading-relaxed">
              e-DiVA is a platform that provides resources to support people who
              care for a loved one living with dementia (also known as carers or
              care partners).
            </p>
            <p className="text-gray-700 leading-relaxed">
